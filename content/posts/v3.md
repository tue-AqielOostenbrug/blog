...
*Design, build, evaluate and document the IRC client as a complete software product using the industry standard software protocol, and
hardware and software testing*
- [ ] **Staying organized using Scrum**: \
*An Agile development methodology should be used to integrate features in Iterations to providing effective feedback loops*
- [ ] ~~**Fly to Mount Doom**~~
